...
async function seedPoll() {
        ...
        create: [
          {
            questionOrder: 1,
            question:
              "¿Has utilizado algún tipo de herramienta de IA, asistente o similar?",
            type: "single",
            language: "es",
            options: {
              create: [
          ...
          },
          {
            questionOrder: 2,
            question:
              "¿Utilizas en tu día a día alguna herramienta de IA para programación (Cursor, Windsurf, Claude, etc.)?",
            type: "single",
            language: "es",
            options: {
              create: [
                {
                  optionOrder: 1,
                  label:
                    "Sí, uso herramientas de IA para programar diariamente",
                  value: "daily",
                  color: "bg-green-500/20",
                  language: "es",
                },
  ...
  const pollTechnical = await prisma.poll.create({
    data: {
      ...
      description: "Ayúdanos a conocer mejor el perfil de nuestros asistentes",
      language: "es",
      showResults: true,
      allowMultiple: false,
      resultsDelay: 0,
        ...
        create: [
          {
            questionOrder: 1,
            question:
              "¿Te consideras una persona técnica o no técnica en términos de conocimientos de programación?",
            type: "single",
            language: "es",
            options: {
              create: [
  ...
  const pollFeedback = await prisma.poll.create({
    data: {
      ...
      description: "Tu opinión es importante para mejorar futuros eventos",
      language: "es",
      showResults: true,
      allowMultiple: false,
      resultsDelay: 0,
        ...
        create: [
          {
            questionOrder: 1,
            question:
              "Del 1 al 10, ¿qué tan satisfecho estás con el evento actual?",
            type: "single",
            language: "es",
            options: {
              create: [
          ...
          },
          {
            questionOrder: 2,
            question:
              "¿Qué tipo de evento te gustaría para la próxima ocasión?",
            type: "multiple",
            maxSelections: 2,
            language: "es",
            options: {
          ...
          },
          {
            questionOrder: 3,
            question:
              "¿Te interesaría participar como organizador o ponente en futuros eventos?",
            type: "single",
            language: "es",
            options: {
              create: [
                {
                  optionOrder: 1,
                  label:
                    "Sí, me encantaría colaborar en la organización o dar una charla",
                  value: "yes",
                  color: "bg-green-500/20",
                  language: "es",
                },
          ...
          },
          {
            questionOrder: 4,
            question:
              "¿Perteneces a alguna organización que podría estar interesada en participar en este tipo de eventos?",
            type: "single",
            language: "es",
            options: {
              create: [
